...
## 6. Conditions para una auditoría no determinista pero confiable

| Requisito | Descripción |
|-----------|-------------|
| **Rúbricas de evaluación** | Separar explícitamente lo verificable por reglas de lo que requiere juicio experto. |
